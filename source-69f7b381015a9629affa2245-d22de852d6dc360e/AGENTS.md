# AGENTS.md — JurisLinka

## Vue d'ensemble

JurisLinka est une plateforme de référencement d'avocats spécialisés en droit des affaires au Québec. Elle comprend un assistant conversationnel IA (Claude Sonnet) qui oriente les utilisateurs vers les avocats correspondant à leur situation.

---

_Legacy project overview (from template — replaced):_

This document provides an overview of the project structure for developers and AI agents working on this codebase.

## Project Overview

JurisLinka — plateforme de référencement d'avocats en droit des affaires pour entrepreneurs québécois. Assistant IA conversationnel + répertoire d'avocats + formulaire d'inscription. Built with TanStack Start and deployed on Netlify.
